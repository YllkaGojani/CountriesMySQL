...
-- 6.What query would you run to get all the actors that joined in the 
-- film_id = 369? Your query should return the film_id, title, 
...
-- 7.What query would you run to get all drama films with a rental rate 
-- of 2.99? Your query should return film title, description, 
...
-- joined by SANDRA KILMER? Your query should return film title, 
-- description, release year, rating, special features, genre, 
-- and actor's first name and last name.
SELECT film.film_id,film.title,film.description,film.release_year,film.rating,film.special_features,category.name,CONCAT(actor.first_name,' ',actor.last_name) as actor_name
FROM category
